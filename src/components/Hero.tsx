...
const Hero = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1587368062478-e804f5e2a55a?q=80&w=1023&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      }}
    >
      {/* Overlay */}
