...
const ItineraryPage = () => {
  ...
  const featuresList = [
    ...
    { key: "accommodationBronze", label: "Bronze: Shared room in a cozy hostel or traditional riad" },
    { key: "accommodationSilver", label: "Silver: Private room in a comfortable 2-star hotel" },
    { key: "accommodationGold", label: "Gold: Private room in a stylish 3-star hotel" },
